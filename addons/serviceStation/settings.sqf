...
/////////////////////
// General
_Radius = 9;								// Area (meters) the SS will scan for vehicles.
_Lights = false;								// Blinking lights on/off. True = on.
...
_RemoveWheelSpeed = 3;						// Time in seconds it takes to remove a damaged wheel.
_MountWheelSpeed = 3.5;						// Time in seconds it takes to mount a new wheel.
