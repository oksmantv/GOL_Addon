...
////////////////////////////////////////////////////////
    ...
    {
    	idc = 1601;
    	action = "[(lbCurSel 2101),(lbCurSel 2100)] call GW_Callsigns_fnc_SetCallsign;";
    ...
    {
    	idc = 2100;
    	OnMouseButtonClick = "(lbCurSel 2100) call GW_Callsigns_fnc_ElementSelected;";
    ...
    class Blu_RscIcon: RscPicture
    {
    	...
    	text = "\x\gw\addons\callsigns\Logo.paa";
    	x = 0.37625 * safezoneW + safezoneX;
    	y = 0.39 * safezoneH + safezoneY;
